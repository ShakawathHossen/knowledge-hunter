...
const Blog = (props) => {
    const { id, name, blogTitle, readTimestamp, publishedDate, authorImage, blogImage } = props.blog;
            ...
            <div className="card bg-base-100 w-11/12 shadow-lg shadow-indigo-500/40  border-2 p-3 my-6">
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='flex gap-3'>
                        <p className='text-slate-400'>0{readTimestamp} min read</p>
                        <span className='bookmark'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
