            ...
            <div className="card bg-base-100 w-11/12 shadow-lg shadow-indigo-500/40  border-2 p-3 my-6">
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='flex gap-3'>
                        ...
                        <span id='bookmark-icon'  title="Click to Bookmark" onClick={()=>updateBookmark(props.blog)} className='bookmark'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
